...
const looksLikeOptions = computed(() => npcs.value
  ...
  .map(npc => ({
    ...
    disabled: !npc.leonardoImageId,
    description: npc.leonardoImageId ? undefined : 'Not generated by Leonardo'
  })))

const description = ref('')
const looksLikeNpcId = ref('')
...
async function generate(): Promise<void> {
  ...
  try {
    ...
    generatedImage.value = await generateLeonardoNpcImage(apiKey.value, {
      ...
      looksLikeGeneratedImageId: looksLikeNpc?.leonardoImageId
    })
  } catch (err) {
  ...
  >
    <template #body>
      <div class="flex flex-col gap-4">
        ...
        <UFormField label="Looks like">
          <USelectMenu
            v-model="looksLikeNpcId"
            :items="looksLikeOptions"
            value-key="value"
            class="w-full"
            placeholder="None"
          />
